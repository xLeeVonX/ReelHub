...
namespace ReelHub.Website.Controllers
{
    public class DirectorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Birthdate,ImageUrl")] Director director)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,FirstName,LastName,Birthdate,ImageUrl")] Director director)
        {
            if (id != director.Id)
            {
                return NotFound();
